  ...
  if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('news/sw.js', {
      ...
      .then(registration => {
        ...
        console.log({ 'registration.pushManager.permissionState': registration.pushManager.permissionState });
        registration.pushManager.permissionState.ajTrace;
        ...
        registration.showNotification('Andrew\'s ServiceWorker Cookbook', {
          body: 'your food on static news is ready...',
        })
      })
      .catch(err => {
